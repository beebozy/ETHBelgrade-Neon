...
async function deployContract(contractName, contractAddress = null, constructorArgs = []) {
    ...
    // Check and airdrop NEON if needed
    ...
    if (!config.composability[contractName][network.name] && !contractAddress) {
        ...
        // Modified deployment with constructor arguments
